...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="ProCategoryReport.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="GetData" TypeName="DataSet1TableAdapters.Product_categoryTableAdapter"></asp:ObjectDataSource>
    </form>
</body>
</html>
