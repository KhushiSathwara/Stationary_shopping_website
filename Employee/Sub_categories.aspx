<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sub_categories.aspx.cs" Inherits="Employee_sub_categories" %>
...
<body>
         ...
         <div class="main-panel">
          <div class="content-wrapper">
           <div class="page-header">
              <h3 class="page-title">Sub categories tables </h3>
            </div>
              <div class="row">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
        DataKeyNames="sub_cat_id" DataSourceID="SqlDataSource1">
        <Columns>
