<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product.aspx.cs" Inherits="Employee_product" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
        ...
        <Columns>
            <asp:BoundField DataField="p_id" HeaderText="p_id" ReadOnly="True" 
                SortExpression="p_id" ItemStyle-Width="100px">
            ...
            <asp:BoundField DataField="m_id" HeaderText="m_id" 
                SortExpression="m_id" ItemStyle-Width="100px">
            <ItemStyle Width="100px" />
            </asp:BoundField>
            <asp:BoundField DataField="price" HeaderText="price" 
                SortExpression="price" ItemStyle-Width="100px" >
            <ItemStyle Width="100px" />
            </asp:BoundField>
            <asp:ImageField DataImageUrlField="image" HeaderText="image" ControlStyle-Width="100px" 
            ControlStyle-Height="80px" ItemStyle-Width="80px">
            </asp:ImageField>
        </Columns>
