<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_material.aspx.cs" Inherits="Employee_product_material" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
        DataKeyNames="m_id" DataSourceID="SqlDataSource1">
        <Columns>
