<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employee_details.aspx.cs" Inherits="Employee_distr" %>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="sub_categories.aspx">
                <span class="menu-title"> Sub categoriesTable</span>
                <i class="nav flex-column sub-menu"></i>
              </a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="inventory.aspx">
                <span class="menu-title"> Inventory Table</span>
                <i class="nav flex-column sub-menu"></i>
              </a>
            </li>
             <li class="nav-item">
         ...
         <div class="main-panel">
          <div class="content-wrapper">
           <div class="page-header">
              <h3 class="page-title"> Employee details table </h3>
            </div>
              <div class="row">
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        SelectCommand="SELECT * FROM [Employee_details]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="e_id" DataSourceID="SqlDataSource1" CssClass="table table-striped" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="e_id" HeaderText="e_id" ReadOnly="True" 
                SortExpression="e_id" ItemStyle-Width="100px">
<ItemStyle Width="100px"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="e_name" HeaderText="e_name" 
                SortExpression="e_name" ItemStyle-Width="100px">
<ItemStyle Width="100px"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="passwd" HeaderText="passwd" 
                SortExpression="passwd" ItemStyle-Width="100px">
<ItemStyle Width="100px"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="e_mobileno" HeaderText="e_mobileno" 
                SortExpression="e_mobileno" ItemStyle-Width="100px">
<ItemStyle Width="100px"></ItemStyle>
            </asp:BoundField>
...
<ItemStyle Width="100px"></ItemStyle>
            ...
            <asp:BoundField DataField="salary" HeaderText="salary" 
                SortExpression="salary" ItemStyle-Width="100px"  >
<ItemStyle Width="100px"></ItemStyle>
            </asp:BoundField>
        </Columns>
                  ...
                  <table class="w-100">
                      ...
                      <tr>
                          <td colspan="2" align="center">
                              <asp:Button ID="btninsert" runat="server" onclick="btninsert_Click" CssClass="btn btn-info"
                                  Text="Insert" />
&nbsp;
