<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_order.aspx.cs" Inherits="Admin_Customer_details" %>
...
<body>
    ...
    <div>
      ...
      <div class="container-fluid page-body-wrapper">
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Customer order Table </h3>
        ...
        SelectCommand="SELECT * FROM [Customer_order]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="c_order_id" DataSourceID="SqlDataSource1"
        CssClass="table table-striped table-bordered" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
    <Columns>
        <asp:CommandField ShowSelectButton="True" />
        <asp:BoundField DataField="c_order_id" HeaderText="c_order_id" ReadOnly="True" SortExpression="c_order_id" ItemStyle-Width="100px" />
        <asp:BoundField DataField="c_id" HeaderText="c_id" SortExpression="c_id" ItemStyle-Width="100px" />
        <asp:BoundField DataField="p_id" HeaderText="p_id" SortExpression="p_id" ItemStyle-Width="100px" />
        <asp:BoundField DataField="quantity" HeaderText="quantity" SortExpression="quantity" ItemStyle-Width="100px" />
        <asp:BoundField DataField="e_id" HeaderText="e_id" SortExpression="e_id" ItemStyle-Width="100px"/>
        <asp:BoundField DataField="place" HeaderText="place" SortExpression="place" ItemStyle-Width="100px" />
        <asp:BoundField DataField="delivery_date" HeaderText="delivery_date" SortExpression="delivery_date" ItemStyle-Width="100px"/>
    ...
    <table class="w-100">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control"
                    DataSourceID="SqlDataSource2" DataTextField="c_name" 
                    DataValueField="c_id">
                </asp:DropDownList>
                <br />
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT [c_id], [c_name] FROM [Customer]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td class="style2">
                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control"
                    DataSourceID="SqlDataSource3" DataTextField="p_name" 
                    DataValueField="p_id">
                </asp:DropDownList>
                <br />
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control"
                    DataSourceID="SqlDataSource4" DataTextField="e_name" 
                    DataValueField="e_id">
                </asp:DropDownList>
                <br />
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT [e_id], [e_name] FROM [Employee_details]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <asp:Button ID="btndlt" runat="server" onclick="btndlt_Click" CssClass="btn btn-info" Text="Delete" />&nbsp;
