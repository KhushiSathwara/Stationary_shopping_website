         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Salary Table </h3>
             
            </div>
            <div class="row">
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:DatabaseConnectionString2 %>" 
        SelectCommand="SELECT * FROM [Salary]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="salary_id" DataSourceID="SqlDataSource1" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="salary_id" HeaderText="salary_id" ReadOnly="True" 
                SortExpression="salary_id" ItemStyle-Width="100px" />
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control"
                    DataSourceID="SqlDataSource3" DataTextField="e_name" DataValueField="e_id">
                </asp:DropDownList>
                <br />
