<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_receipt.aspx.cs" Inherits="Admin_Customer_receipt" %>
...
<body>
    ...
    <div>
      ...
      <div class="container-fluid page-body-wrapper">
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Customer receipt Table </h3>
        ...
        SelectCommand="SELECT * FROM [Customer_receipt]"></asp:SqlDataSource>
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="c_rec_id" DataSourceID="SqlDataSource3" 
                    OnSelectedIndexChanged="GridView3_SelectedIndexChanged" 
                    CssClass="table table-striped">
    <Columns>
        <asp:CommandField ShowSelectButton="True" ItemStyle-Width="50px" />
        <asp:BoundField DataField="c_rec_id" HeaderText="c_rec_id" ReadOnly="True" SortExpression="c_rec_id" ItemStyle-Width="100px" />
        <asp:BoundField DataField="c_id" HeaderText="c_id" SortExpression="c_id" ItemStyle-Width="100px" />
        <asp:BoundField DataField="payment_date" HeaderText="payment_date" SortExpression="payment_date" ItemStyle-Width="100px" />
        <asp:BoundField DataField="amount" HeaderText="amount" SortExpression="amount" ItemStyle-Width="100px" />
        <asp:BoundField DataField="mode" HeaderText="mode" SortExpression="mode" ItemStyle-Width="100px" />
    </Columns>
    ...
    <table class="w-100">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="dropdown1" runat="server" class="form-control"
                    DataSourceID="SqlDataSource4" DataTextField="c_name" 
                    DataValueField="c_id">
                </asp:DropDownList>
                <br />
