<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Distributer_details.aspx.cs" Inherits="Admin_Distributer_details" %>
         ...
         <div class="main-panel">
          <div class="content-wrapper">
           <div class="page-header">
              <h3 class="page-title"> Distributer details Table </h3>
            </div>
              <div class="row">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        SelectCommand="SELECT * FROM [Distributer_details]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    DataKeyNames="d_details_id" DataSourceID="SqlDataSource1" 
    CssClass="table table-striped table-bordered" 
                      onselectedindexchanged="GridView1_SelectedIndexChanged1">
    <Columns>
        <asp:CommandField ShowSelectButton="True" />
        <asp:BoundField DataField="d_details_id" HeaderText="d_details_id" 
            ReadOnly="True" SortExpression="d_details_id" />
    ...
    <table class="w-100">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server" class="form-control"
                    DataSourceID="SqlDataSource2" DataTextField="p_name" 
                    DataValueField="p_id">
                </asp:DropDownList>
                <br />
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Button ID="Button1" runat="server" Text="Insert" CssClass="btn btn-info" OnClick="Button1_Click" />
&nbsp;
