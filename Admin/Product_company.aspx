<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_Company.aspx.cs" Inherits="Admin_Product_Company" %>
...
<body>
    ...
    <div>
      ...
      <div class="container-fluid page-body-wrapper">
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Product Company Table </h3>
        ...
        SelectCommand="SELECT * FROM [Poduct_company]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="cmp_id" DataSourceID="SqlDataSource1" 
        onselectedindexchanged="GridView1_SelectedIndexChanged" CssClass="table table-striped table-bordered">
        <Columns>
            <asp:CommandField ShowSelectButton="True" />
            <asp:BoundField DataField="cmp_id" HeaderText="cmp_id" ReadOnly="True" 
                SortExpression="cmp_id" ItemStyle-Width="100px" />
    ...
    <table class="w-100">
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Button ID="btnisert" runat="server" onclick="btnisert_Click" CssClass="btn btn-info"
                    Text="Insert" />&nbsp;
