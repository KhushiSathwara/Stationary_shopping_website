...
<body>
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> State table </h3>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="state_code" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered"
        onselectedindexchanged="GridView1_SelectedIndexChanged">
        <Columns>
            <asp:CommandField ShowSelectButton="True" ItemStyle-Width="50px"/>
            <asp:BoundField DataField="state_code" HeaderText="state_code" ReadOnly="True" 
                SortExpression="state_code" ItemStyle-Width="100px" />
            <asp:BoundField DataField="state_name" HeaderText="state_name" 
                SortExpression="state_name" ItemStyle-Width="100px" />
        </Columns>
