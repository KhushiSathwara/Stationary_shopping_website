<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sub_categories.aspx.cs" Inherits="Admin_Sub_categories" %>
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Sub Categories Table </h3> 
            </div>
            <div class="row">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        SelectCommand="SELECT * FROM [Sub_categories]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="sub_cat_id" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered"
        onselectedindexchanged="GridView1_SelectedIndexChanged">
        <Columns>
            <asp:CommandField ShowSelectButton="True" ItemStyle-Width="100px" />
            <asp:BoundField DataField="sub_cat_id" HeaderText="sub_cat_id" ReadOnly="True" 
                SortExpression="sub_cat_id" ItemStyle-Width="100px"/>
            <asp:BoundField DataField="sub_cat_name" HeaderText="sub_cat_name" 
                SortExpression="sub_cat_name" ItemStyle-Width="100px"/>
