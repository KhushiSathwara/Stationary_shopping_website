<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Distributer.aspx.cs" Inherits="Admin_Distributer" %>
...
<body>
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Distributer Table </h3>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="d_mobileno" HeaderText="d_mobileno" 
            SortExpression="d_mobileno" />
        <asp:BoundField DataField="gst_no" HeaderText="gst_no" 
            SortExpression="gst_no" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT [city_id], [city_name] FROM [City]"></asp:SqlDataSource></td>
        </tr>
        <tr>
            <td colspan="2" class="style2" align="center">
                ...
                <asp:Button ID="btnupdate" runat="server" onclick="btnupdate_Click" CssClass="btn btn-info"
                    Text="update" />&nbsp;
                <asp:Button ID="btndlt" runat="server" onclick="btndlt_Click" Text="delete" CssClass="btn btn-info"/>
                <br />
            </td>
        </tr>
    </table>
