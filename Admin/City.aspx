...
<body>
   ...
   <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="city_id" DataSourceID="SqlDataSource2" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" CssClass="table table-striped">
    <Columns>
        <asp:CommandField ShowSelectButton="True" ItemStyle-Width="50px"> <ItemStyle Width="50px"></ItemStyle> </asp:CommandField >
        <asp:BoundField DataField="city_id" HeaderText="City ID" ReadOnly="True" SortExpression="city_id" >
        ...
        <SelectedRowStyle BackColor="#669999" Font-Bold="True" ForeColor="White" />
                  ...
                  <table class="w-100">
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="TextBox2" runat="server" class="form-control"></asp:TextBox></td>
                      </tr>
                      <tr>
                          <td>
                              state_code</td>
