    ...
    <table class="w-100">
        ...
        <tr>
            <td class="style1" colspan="2" align="center">
                ...
                <asp:Button ID="Button2" runat="server" onclick="btnupdate_Click" CssClass="btn btn-info"
                    Text="Update" />&nbsp;
                <asp:Button ID="Button3" runat="server" onclick="btndlt_Click" Text="Delete" CssClass="btn btn-info"/>
                <br />
            </td>
        </tr>
    </table>
