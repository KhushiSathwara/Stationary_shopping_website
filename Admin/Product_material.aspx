<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_material.aspx.cs" Inherits="Admin_Product_material" %>
...
<body>
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Product Material Table </h3>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="m_id" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered"
        onselectedindexchanged="GridView1_SelectedIndexChanged">
        <Columns>
            <asp:CommandField ShowSelectButton="True" ItemStyle-Width="50px"/>
            <asp:BoundField DataField="m_id" HeaderText="m_id" ReadOnly="True" 
                SortExpression="m_id" ItemStyle-Width="100px"/>
            <asp:BoundField DataField="m_name" HeaderText="m_name" 
                SortExpression="m_name" ItemStyle-Width="100px"/>
        </Columns>
