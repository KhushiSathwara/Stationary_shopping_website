<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Distributer_receipt.aspx.cs" Inherits="Admin_Distributer_receipt" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div class="container-fluid page-body-wrapper">
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Distributer receipt Table </h3>
        ...
        SelectCommand="SELECT * FROM [Distributer_receipt]"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    DataKeyNames="d_rec_id" DataSourceID="SqlDataSource1" 
    CssClass="table table-striped table-bordered">
    <Columns>
        <asp:CommandField ShowSelectButton="True" ItemStyle-Width="50px"/>
        <asp:BoundField DataField="d_rec_id" HeaderText="d_rec_id" ReadOnly="True" 
            SortExpression="d_rec_id" ItemStyle-Width="100px" />
        <asp:BoundField DataField="d_id" HeaderText="d_id" SortExpression="d_id" ItemStyle-Width="100px"/>
        <asp:BoundField DataField="payment_date" HeaderText="payment_date" 
            SortExpression="payment_date" ItemStyle-Width="100px"/>
        <asp:BoundField DataField="amount" HeaderText="amount" 
            SortExpression="amount" ItemStyle-Width="100px"/>
    ...
    <table class="w-100">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server" class="form-control"
                    DataSourceID="SqlDataSource2" DataTextField="d_name" 
                    DataValueField="d_id">
                </asp:DropDownList>
                <br />
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT * FROM [Distributer]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <asp:Button ID="btndlt" runat="server" Text="Delete" onclick="btndlt_Click" CssClass="btn btn-info"/>
                <br />
            </td>
        </tr>
    </table>          
