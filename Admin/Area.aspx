<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Area.aspx.cs" Inherits="Admin_Area" %>
...
<body>
      ...
      <div class="container-fluid page-body-wrapper">
         ...
         <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Area Table </h3>
        ...
        <!-- main-panel ends -->
               ...
               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="pincode" DataSourceID="SqlDataSource1" 
                    CssClass="table table-striped" 
                    onselectedindexchanged="GridView1_SelectedIndexChanged1">
    <Columns>
        <asp:CommandField ShowSelectButton="True" > <ItemStyle Width="50px"></ItemStyle> </asp:CommandField >
        <asp:BoundField DataField="pincode" HeaderText="Pincode" ReadOnly="True" SortExpression="pincode" >
              <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField >
        <asp:BoundField DataField="area_name" HeaderText="Area Name" SortExpression="area_name" >
              <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField >
        <asp:BoundField DataField="city_id" HeaderText="City ID" SortExpression="city_id" >
              <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField >
    </Columns>
                ...
                <table class="w-100">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Button ID="btninsert" runat="server" onclick="Button1_Click" CssClass="btn btn-info" Text="insert" />&nbsp;
                            <asp:Button ID="btnupdate" runat="server" Text="update" CssClass="btn btn-info" onclick=" Button2_Click" />&nbsp;
                            <asp:Button ID="btndlt" runat="server" CssClass="btn btn-info" onclick="btndelete_Click" Text="delete" />
                            <br />
                        </td>
                    </tr>
                </table>
    ...
    <script>
        $(document).ready(function () {
            $("#tablesMenu").click(function () {
                $("#tablesSubMenu").toggle(); // Toggle the visibility of the submenu
            });
        });
    </script>
    </div>
